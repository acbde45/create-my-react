...
const { savePreset, rcPath, saveOptions } = require('./utils/options');
...
async function create(name) {
  ...
  // 填入 react vite 必选项，无需用户选择
  answers.features.unshift('react', 'vite');
...
function getPromptModules() {
  return ['linter', 'typescript'].map(file => require(`./promptModules/${file}`));
}
